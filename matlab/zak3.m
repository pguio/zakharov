function s=zak3(paramfile)
% function s=zak3(paramfile)

%
% $Id: zak3.m,v 1.8 2011/03/26 09:20:42 patrick Exp $
%
...
ne0 = n0.*(s.edrive*exp(-i*(s.domega+s.w)*s.t0)+e0);
ftne0 = fft(ne0);
fte0 = fft(e0);
...
e12 = abs(s.edrive*exp(-i*(s.domega+s.w)*(s.t0+s.h))+e1).^2;
