function s=zak4(paramfile)
% function s=zak4(paramfile)

%
% $Id: zak4.m,v 1.2 2011/03/26 09:20:42 patrick Exp $
%
...
fte02 = fft(abs(s.edrive+ifft(fte0)).^2);
