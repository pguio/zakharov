function s=zak1(paramfile)
% function s=zak1(paramfile)

%
% $Id: zak1.m,v 1.17 2011/03/26 09:20:42 patrick Exp $
%
...
options = odeset('RelTol',1e-3,'Stats','on','NormControl','on','Vectorized','on');
...
dEk = -(s.nye(j) + s.ik2(j) - i*(s.domega+s.w)).*Ek(j) -i*nEk(j);
dEk(1) = dEk(1) + i*njEjm;
