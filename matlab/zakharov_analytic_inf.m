function solver=zakharov_analytic_inf(f,varargin)
% function solver=zakharov_analytic_inf(f,varargin)

%
% $Id: zakharov_analytic_inf.m,v 1.9 2011/03/26 09:20:42 patrick Exp $
%
...
if solver.nb~=1
	error('zakharov_analytic_inf can only handle one soliton');
end
if solver.display
...
for i=1:solver.maxiter,
	...
	[E,n,dn]=analytic_inf_one_soliton(solver,1);
	solver.Ej=E;
	solver.nj=n;
	solver.dnj=dn;
