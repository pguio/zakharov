...
%
% $Id: fig8.m,v 1.3 2001/09/27 07:48:40 patricg Exp $
%
...
plot(solver.xj,real(solver.njs(:,imn)))
set(gca,'xticklabel',[]);
set(gca,'xlim',[-80 80],'ylim',[-2 0.5]);
ticks=get(gca,'yticklabel'); ticks(1,:)=' '; set(gca,'yticklabel',ticks);
legend(sprintf('%.1f',solver.times(imn)),4)
