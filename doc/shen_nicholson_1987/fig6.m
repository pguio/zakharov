...
%
% $Id: fig6.m,v 1.3 2007/05/27 14:42:50 patrick Exp $
%
...
k = linspace(0,2.0,200);

nse=growth_rate_nse(k,E0);
zak=growth_rate_zak(k,E0);

options=optimset;
knse=fminbnd('growth_rate_nse',0.0,2.0,options,E0,-1);
kzak=fminbnd('growth_rate_zak',0.0,2.0,options,E0,-1);
